...
// Modified 2023, William Black <william.s.black.ctr@navy.mil>
//
// GENERAL PURPOSE: 
...
int thresholdValue = 2000; //comparison value in centimeters to trigger data send when sensor sees object  
